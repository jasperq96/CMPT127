...
//For lab 4 function integration
#include "t1.h"
...
int main( int argc, char* argv[] )
{
  ...
  // todo: this is a good place to use some image-modifying functions from imgops.c
	uint8_t * img1 = img;
  printf("imgwidth: %i, imgheight: %i\n",imgwidth, imgheight);
	draw_circle(img1, imgwidth, imgheight, imgwidth/2, imgheight/2, 5, 255);
  ...
  draw_image_grey( img1, imgwidth, imgheight );
